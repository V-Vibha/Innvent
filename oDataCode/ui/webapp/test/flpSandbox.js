		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapbpmpvinnventui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapbpmpvinnventui-display": {
								"semanticObject": "comsapbpmpvinnventui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.bpm.pv.innvent.ui",
									"url": sap.ui.require.toUrl("com/sap/bpm/pv/innvent/ui")
								}
							}
						}
					}
