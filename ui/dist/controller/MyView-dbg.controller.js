  ...
  function (
    ...
    return Controller.extend("com.sap.bpm.pv.innvent.ui.controller.MyView", {
      ...
      onInit: function (evt) {
        ...
        //Odata query parameters for select


        // Set the model on the view
        // this.getView().setModel(OdataModel);

        // Get a reference to the TreeMap
        ...
        //   console.log(OdataModel.getData());
          //  oTreeMap.setModel(OdataModel);
          //  oTreeMap.setDataset(treeDataset);
        // Bind the TreeMap to the OData model
        // oTreeMap.bindRows({
        //     path: "/Instances",
        //     parameters: {
        //         expand: "results"
        ...
        //           {
        //         var dataModel = new JSONModel(temp_var);
        //         console.log(dataModel.getJSON());
        //         oVizFrame.setModel(dataModel.getJSON());
